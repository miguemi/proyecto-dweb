...
from core.base.forms import ClientForm
from core.base.mixins import ValidatePermissionRequiredMixin
from core.base.models import Client


class ClientListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    model = Client
    template_name = 'client/list.html'
    permission_required = 'base.view_client'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('client:cl_create')
        context['list_url'] = reverse_lazy('client:cl_list')
...
class ClientCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('client:cl_list')
    permission_required = 'base.add_client'
...
class ClientUpdateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    ...
    template_name = 'client/create.html'
    success_url = reverse_lazy('client:cl_list')
    permission_required = 'base.change_client'
    url_redirect = success_url
...
class ClientDeleteView(LoginRequiredMixin, ValidatePermissionRequiredMixin, DeleteView):
    ...
    success_url = reverse_lazy('client:cl_list')
    permission_required = 'base.delete_client'
    url_redirect = success_url
